...
LifeDay = ScreenPlay:new {
	...
	mobiles = {
		{ mobile = "kkatamk", planet = "naboo", x = -4902.8, z = 6.0, y = 4132.4, angle = 33 }, -- Lake Retreat -- Changed to Theed
		{ mobile = "kkatamk", planet = "tatooine", x = 130.3, z = 52.0, y = -5383.7, angle = -88 }, -- Anchorhead
		{ mobile = "kkatamk", planet = "corellia", x = -167.3, z = 28.0, y = -4723.4, angle = -87 }, -- Vreni Island -- Changed to Coronet 
