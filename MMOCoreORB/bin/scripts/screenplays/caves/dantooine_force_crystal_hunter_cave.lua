...
function ForceCrystalCaveScreenPlay:spawnMobiles()   
	...
	spawnMobile("dantooine", "force_sensitive_crypt_crawler",900,26.1,-43,-68.3,84,8535484)
	...
	spawnMobile("dantooine", "force_sensitive_crypt_crawler",900,69.3,-75.7,-65.4,30,8535486)
	...
	spawnMobile("dantooine", "untrained_wielder_of_the_dark_side",900,22.4,-42.1,-64.1,38,8535484)
	spawnMobile("dantooine", "untrained_wielder_of_the_dark_side",900,49.8,-48.5,-65.6,-51,8535484)
	spawnMobile("dantooine", "untrained_wielder_of_the_dark_side",900,49.7,-48,-17.7,167,8535484)
end
