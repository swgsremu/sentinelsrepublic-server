...
object_ship_blacksun_heavy_s03_tier1 = object_ship_shared_blacksun_heavy_s03_tier1:new {
	objectName = "@space/space_mobile_type:blacksun_heavy_s03_tier1",

	name = "blacksun_heavy_tier1",
	type = "blacksun_heavy_s03_tier1",
	faction = "blacksun",
	difficulty = "tier1",
...
ObjectTemplates:addTemplate(object_ship_blacksun_heavy_s03_tier1, "object/ship/blacksun_heavy_s03_tier1.iff")
