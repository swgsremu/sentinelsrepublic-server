...
object_ship_hutt_heavy_s01_tier2 = object_ship_shared_hutt_heavy_s01_tier2:new {
	objectName = "@space/space_mobile_type:hutt_heavy_s01_tier2",

	name = "hutt_heavy_tier2",
	type = "hutt_heavy_s01_tier2",
	faction = "hutt",
	difficulty = "tier2",
...
ObjectTemplates:addTemplate(object_ship_hutt_heavy_s01_tier2, "object/ship/hutt_heavy_s01_tier2.iff")
