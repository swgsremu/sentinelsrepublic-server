...
object_ship_hutt_light_s01_tier2 = object_ship_shared_hutt_light_s01_tier2:new {
	objectName = "@space/space_mobile_type:hutt_light_s01_tier2",

	name = "hutt_light_tier2",
	type = "hutt_light_s01_tier2",
	faction = "hutt",
	difficulty = "tier2",
	...
	shield_0 = {name = "shd_generic", hitpoints = 450, armor = 450, front = 1620, back = 1620, regen = 5.4},
...
ObjectTemplates:addTemplate(object_ship_hutt_light_s01_tier2, "object/ship/hutt_light_s01_tier2.iff")
