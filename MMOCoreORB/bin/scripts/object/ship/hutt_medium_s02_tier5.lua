...
object_ship_hutt_medium_s02_tier5 = object_ship_shared_hutt_medium_s02_tier5:new {
	objectName = "@space/space_mobile_type:hutt_medium_s02_tier5",

	name = "hutt_medium_tier5",
	type = "hutt_medium_s02_tier5",
	faction = "hutt",
	difficulty = "tier5",
...
ObjectTemplates:addTemplate(object_ship_hutt_medium_s02_tier5, "object/ship/hutt_medium_s02_tier5.iff")
