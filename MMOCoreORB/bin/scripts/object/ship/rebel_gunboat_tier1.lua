...
object_ship_rebel_gunboat_tier1 = object_ship_shared_rebel_gunboat_tier1:new {
	objectName = "@space/space_mobile_type:rebel_gunboat_tier1",

	name = "rebel_gunboat_tier1",
	type = "rebel_gunboat_tier1",
	faction = "rebel",
	difficulty = "tier1",
	...
	weapon_2 = {name = "wpn_incom_disruptor", hitpoints = 1500, armor = 1500, rate = 0.78, drain = 1, maxDamage = 100, minDamage = 75, shieldEfficiency = 0.56, armorEfficiency = 0.56, ammo = 0, ammo_type = 0},
