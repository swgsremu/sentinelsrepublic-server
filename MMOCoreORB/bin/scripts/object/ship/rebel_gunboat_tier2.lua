...
object_ship_rebel_gunboat_tier2 = object_ship_shared_rebel_gunboat_tier2:new {
	objectName = "@space/space_mobile_type:rebel_gunboat_tier2",

	name = "rebel_gunboat_tier2",
	type = "rebel_gunboat_tier2",
	faction = "rebel",
	difficulty = "tier2",
	...
	weapon_2 = {name = "wpn_incom_disruptor", hitpoints = 4500, armor = 4500, rate = 0.78, drain = 1, maxDamage = 220, minDamage = 157.5, shieldEfficiency = 0.56, armorEfficiency = 0.56, ammo = 0, ammo_type = 0},
