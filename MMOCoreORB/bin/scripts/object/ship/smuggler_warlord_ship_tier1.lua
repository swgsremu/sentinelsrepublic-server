...
object_ship_smuggler_warlord_ship_tier1 = object_ship_shared_smuggler_warlord_ship_tier1:new {
	objectName = "@space/space_mobile_type:smuggler_warlord_ship_tier1",

	name = "smuggler_warlord_ship_tier1",
	type = "smuggler_warlord_ship_tier1",
	faction = "civilian",
	difficulty = "tier1",
	...
	weapon_1 = {name = "wpn_incom_disruptor", hitpoints = 1500, armor = 1500, rate = 0.78, drain = 1, maxDamage = 100, minDamage = 75, shieldEfficiency = 0.56, armorEfficiency = 0.56, ammo = 0, ammo_type = 0},
	...
	weapon_3 = {name = "wpn_incom_disruptor", hitpoints = 1500, armor = 1500, rate = 0.78, drain = 1, maxDamage = 100, minDamage = 75, shieldEfficiency = 0.56, armorEfficiency = 0.56, ammo = 0, ammo_type = 0},
