...
--Sets a jedi experience multiplier
...
baseStoredShips = 8
baseStoredFamiliarPets = 8

-----------------------------------
--VETERAN REWARDS CONFIG
-----------------------------------
veteranRewardMilestones = {30, 45, 60, 90, 120, 150, 180, 210, 240, 270, 300, 360} --days, must be sorted low to high
