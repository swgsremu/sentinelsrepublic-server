...
space_dantooine = {
	spaceStations = {
		...
		{templateFile = "spacestation_rebel", x = -4200, z = -3000, y = -6000, ow = 1, ox = 0, oy = 0, oz = 0, parentid = 0},
...
space_dathomir = {
	spaceStations = {
		...
		{templateFile = "spacestation_neutral", x = 4000, z = 200, y = -4700, ow = 1, ox = 0, oy = 0, oz = 0, parentid = 0},
...
space_endor = {
	spaceStations = {
		...
		{templateFile = "spacestation_imperial", x = 6200, z = 5000, y = 6000, ow = 1, ox = 0, oy = 0, oz = 0, parentid = 0},
...
space_heavy1 = {
	spaceStations = {
		{templateFile = "spacestation_freedom", x = -6000, z = 0, y = 0, ow = 0, ox = 1, oy = 0, oz = 0, parentid = 0},
	}
}
